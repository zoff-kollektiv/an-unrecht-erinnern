...
<main class="main">
  ...
  <div class="block-content">
    ...
    <ul class="wp-block-more">
      <li>
        <a href="#" class="wp-block-more__item">
          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 45 60" class="wp-block-more__item-icon">
          ...
          <div class="wp-block-more__item-content-container">
            <h3 class="wp-block-more__item-title">Frauen als Kriegsgefangene</h3>
            <p class="wp-block-more__item-description">Lorem ipsum dolor sit amet, consetetur sadipscing elitr, sed diam
